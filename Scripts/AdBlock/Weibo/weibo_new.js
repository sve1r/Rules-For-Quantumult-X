...
function handleNoneSdkAd(content) {
    ...
    if (true === url.includes("/2/cardlist")) {
    ...
    } else if (true === url.includes("/2/profile/dealatt") || url.includes("/2/friendships/")) {
        ...
        handleSearchAll(obj);
    } else if (true === url.includes("/2/shproxy/chaohua/discovery/searchactive")) {
    ...
    } else if (true === url.includes("/2/statuses/container_timeline_hot") || url.includes("/2/statuses/unread_hot_timeline")) {
        handleContainerTimelineHot(obj);
    } else if (true === url.includes("/2/statuses/container_timeline?") || url.includes("/2/statuses/container_timeline_unread")) {
    ...
    } else if (true === url.includes("/2/!/huati/discovery_home_bottom_channels")) {
        handleTopicDiscovery(obj); //话题发现页面
    } else if (true === url.includes("/aj/appicon/list")) {
        handleAppIconList(obj); //app 图标
    } else if (true === url.includes("/v1/ad/preload") || url.includes("/v2/ad/preload")) {
        handleAdPreload(obj); //预加载广告
    } else if (true === url.includes("/wbapplua/wbpullad.lua") || url.includes("/preload/get_ad")) {
