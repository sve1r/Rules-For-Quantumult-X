...
(function (r) {
    ...
    var o = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g, s = /[\x01-\x7F]/g,
        ...
        q = String.fromCharCode, v = {}, w = v.hasOwnProperty, D = function (r, e) {
            return w.call(r, e)
        }, y = function (r, e) {
            ...
            if (!r) return e;
            var a, t = {};
            for (a in e) t[a] = D(r, a) ? r[a] : e[a];
            return t
        }, E = function (r, e) {
            var a = "";
            return r >= 55296 && r <= 57343 || r > 1114111 ? (e && L("character reference outside the permissible Unicode range"), "�") : D(b, r) ? (e && L("disallowed character reference"), b[r]) : (e && y(h, r) && L("disallowed character reference"), r > 65535 && (r -= 65536, a += q(r >>> 10 & 1023 | 55296), r = 56320 | 1023 & r), a += q(r), a)
        }, x = function (r) {
            ...
            e = A(e, S.options);
            var a = e.strict;
            a && d.test(r) && L("forbidden code point");
            var t = e.encodeEverything, n = e.useNamedReferences, p = e.allowUnsafeSymbols, g = e.decimal ? k : x,
                m = function (r) {
                    return g(r.charCodeAt(0))
                };
            return t ? (r = r.replace(s, function (r) {
                return n && D(l, r) ? "&" + l[r] + ";" : m(r)
            }), n && (r = r.replace(/&gt;\u20D2/g, "&nvgt;").replace(/&lt;\u20D2/g, "&nvlt;").replace(/&#x66;&#x6A;/g, "&fjlig;")), n && (r = r.replace(c, function (r) {
                return "&" + l[r] + ";"
            }))) : n ? (p || (r = r.replace(i, function (r) {
                return "&" + l[r] + ";"
            })), r = r.replace(/&gt;\u20D2/g, "&nvgt;").replace(/&lt;\u20D2/g, "&nvlt;"), r = r.replace(c, function (r) {
                return "&" + l[r] + ";"
            })) : p || (r = r.replace(i, m)), r.replace(o, function (r) {
                var e = r.charCodeAt(0), a = r.charCodeAt(1), t = 1024 * (e - 55296) + a - 56320 + 65536;
                return g(t)
            }).replace(u, m)
        };
    ...
    var C = function (r, e) {
        e = A(e, C.options);
        var a = e.strict;
        return a && p.test(r) && L("malformed character reference"), r.replace(g, function (r, t, o, s, u, c, l, i, n) {
            var p, d, g, b, h, q;
            return t ? (h = t, m[h]) : o ? (h = o, q = s, q && e.isAttributeValue ? (a && "=" == q && L("`&` did not start a character reference"), r) : (a && L("named character reference was not terminated by a semicolon"), f[h] + (q || ""))) : u ? (g = u, d = c, a && !d && L("character reference was not terminated by a semicolon"), p = parseInt(g, 10), E(p, a)) : l ? (b = l, d = i, a && !d && L("character reference was not terminated by a semicolon"), p = parseInt(b, 16), E(p, a)) : (a && L("named character reference was not terminated by a semicolon"), r)
        })
    };
    ...
    }, T = {version: "1.2.0", encode: S, decode: C, escape: B, unescape: C};
    if ("function" == typeof define && "object" == typeof define.amd && define.amd) define(function () {
        return T
    }); else if (e && !e.nodeType) if (a) a.exports = T; else for (var R in T) D(T, R) && (e[R] = T[R]); else r.he = T
})(this);
